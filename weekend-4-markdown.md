...
- [ ] when a task is complete the background of the task container should change    
- [ ] when a task is complete, the complete option should be 'checked off'
- [ ] when the task is complete, the database should reflect this update
